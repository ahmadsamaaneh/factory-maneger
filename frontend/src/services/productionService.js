...
export const getBatches   = (params)   => api.get('/production/batches', { params }).then((r) => r.data.data);
...
export const updateBatch  = (id, d)  => api.patch(`/production/batches/${id}`, d).then((r) => r.data.data);
